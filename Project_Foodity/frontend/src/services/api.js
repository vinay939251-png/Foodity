...
export const recipesAPI = {
  ...
  getRatings: (id) => api.get(`/recipes/${id}/ratings/`),
  addRating: (id, score, review_text) => api.post(`/recipes/${id}/ratings/`, { score, review_text }),
  ...
  autocomplete: (q) => api.get('/recipes/autocomplete/', { params: { q } }),
  getActivityFeed: () => api.get('/recipes/activity/'),
};
...
export const boardsAPI = {
  ...
  getGroceryList: (boardId) => api.get('/grocery-list/', { params: { board_id: boardId } }),
  addCollaborator: (id, userId) => api.post(`/boards/${id}/collaborators/`, { user_id: userId }),
  removeCollaborator: (id, userId) => api.delete(`/boards/${id}/collaborators/`, { data: { user_id: userId } }),
};
