...
export default function AIGenerator() {
 ...
 <h1 className="text-4xl font-display font-bold text-gray-900 dark:text-white mb-4">Gemini AI Chef</h1>
 ...
 <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-orange-50/50">
 ...
 <div>
 <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">What's in your fridge?</label>
 ...
 className="flex-1 px-4 py-2 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary outline-none"
 />
 <button type="button" onClick={() => removeIngredient(i)} disabled={ingredients.length === 1} className="p-2 text-gray-400 dark:text-gray-500 hover:text-red-500 disabled:opacity-50">
 <FiTrash2 />
 </button>
 </div>
 ))}
 ...
 <div>
 <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Any special requests? (Optional)</label>
 <textarea
 value={prompt}
 onChange={e => setPrompt(e.target.value)}
 rows={3}
 placeholder="e.g. Make it low carb, spicy, or kid-friendly..."
 className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-primary outline-none resize-none"
 />
 </div>
 ...
 {/* Results Area */}
 <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-soft border border-gray-100 dark:border-gray-800 flex flex-col overflow-hidden">
 <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-950">
 <h2 className="font-bold text-gray-900 dark:text-white">Generated Recipe</h2>
 </div>
 ...
 <h3 className="text-2xl font-bold font-display text-gray-900 dark:text-white leading-tight">{generatedRecipe.title}</h3>
 <p className="text-gray-600 dark:text-gray-400 italic">{generatedRecipe.description}</p>
 
 <div className="flex flex-wrap gap-2">
 <span className="px-3 py-1 bg-orange-50 text-orange-700 rounded-full text-xs font-bold uppercase tracking-wider">
 {generatedRecipe.difficulty}
 </span>
 <span className="px-3 py-1 bg-gray-100 text-gray-700 dark:text-gray-300 rounded-full text-xs font-medium">
 ...
 <div>
 <h4 className="font-bold text-gray-900 dark:text-white mb-2 border-b border-gray-100 dark:border-gray-800 pb-1">Ingredients</h4>
 ...
 <div>
 <h4 className="font-bold text-gray-900 dark:text-white mb-2 border-b border-gray-100 dark:border-gray-800 pb-1">Instructions</h4>
 ...
 <div><p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Calories</p><p className="font-bold text-gray-900 dark:text-white">{generatedRecipe.nutrition.calories}</p></div>
 <div><p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Protein</p><p className="font-bold text-gray-900 dark:text-white">{generatedRecipe.nutrition.protein}g</p></div>
 <div><p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Carbs</p><p className="font-bold text-gray-900 dark:text-white">{generatedRecipe.nutrition.carbs}g</p></div>
 <div><p className="text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">Fats</p><p className="font-bold text-gray-900 dark:text-white">{generatedRecipe.nutrition.fats}g</p></div>
 </div>
 )}

 <div className="absolute bottom-0 left-0 right-0 p-4 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 flex justify-end">
 <button 
