...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'avatar_url', 'bio', 'is_public', 'date_of_birth',
            'gender', 'country', 'language', 'followers_count',
...
class RatingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Rating
        fields = ['id', 'user', 'score', 'review_text', 'is_mine', 'created_at', 'updated_at']
...
class RecipeListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'rating', 'ratings_count', 'likes_count', 'saves_count',
...
class RecipeDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'difficulty', 'rating', 'ratings_count', 'likes_count', 'saves_count',
            'is_ai_generated', 'source_url',
            'author', 'ingredients', 'steps', 'nutrition',
            'comments', 'ratings', 'is_liked', 'is_saved',
            'created_at', 'updated_at',
        ]
        read_only_fields = ['rating', 'ratings_count', 'likes_count', 'saves_count', 'is_ai_generated']
    ...
    def get_ratings(self, obj):
        ratings = obj.ratings.select_related('user__user').order_by('-created_at')[:10]
...
class BoardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'owner', 'name', 'description', 'is_public',
                  'cover_image', 'collaborators', 'recipe_count', 'cover_images', 'created_at']
...
class ActivitySerializer(serializers.ModelSerializer):
    ...
    target_recipe = RecipeListSerializer(read_only=True)

    class Meta:
        model = Activity
        fields = ['id', 'user', 'action_type', 'target_recipe', 'target_user', 'created_at']
